  ...
  return (
    <div className="fields">
      ...
      <div className="change-img">
        ...
        <input id="file" type="file" onChange={handleChange} className="btnfile" accept=".jpg, .jpeg, .png"/>
      </div>
      <br />
        <button disabled={loading || !photo} onClick={handleClick} className="btn">Envoyer</button>
